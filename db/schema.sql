...
--
-- Name: sync_log; Type: TABLE; Schema: public; Owner: shardbox
--
...
ALTER TABLE public.sync_log OWNER TO shardbox;

--
-- Name: sync_log_id_seq; Type: SEQUENCE; Schema: public; Owner: shardbox
--
...
--
-- Name: categories categories_pkey; Type: CONSTRAINT; Schema: public; Owner: shardbox
--
...
--
-- Name: shard_metrics_current shard_metrics_current_pkey; Type: CONSTRAINT; Schema: public; Owner: shardbox
--
...
--
-- Name: shard_metrics shard_metrics_pkey; Type: CONSTRAINT; Schema: public; Owner: shardbox
--
...
--
-- Name: releases releases_pkey; Type: CONSTRAINT; Schema: public; Owner: shardbox
--
...
--
-- Name: sync_log sync_log_pkey; Type: CONSTRAINT; Schema: public; Owner: shardbox
--
...
--
-- Name: releases releases_shard_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: shardbox
--
...
--
-- Name: shard_dependencies shard_dependencies_depends_on_repo_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: shardbox
--
...
--
-- Name: shard_metrics_current shard_metrics_current_shard_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: shardbox
--
...
--
-- Name: sync_log sync_log_repo_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: shardbox
--
