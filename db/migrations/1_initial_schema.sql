...
ALTER TABLE ONLY public.shard_dependencies
    ADD CONSTRAINT shard_dependencies_depends_on_fkey FOREIGN KEY (depends_on) REFERENCES public.shards(id) ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
...
ALTER TABLE ONLY public.shard_dependencies
    ADD CONSTRAINT shard_dependencies_shard_id_fkey FOREIGN KEY (shard_id) REFERENCES public.shards(id) ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
...
ALTER TABLE ONLY public.shard_metrics_current
    ADD CONSTRAINT shard_metrics_current_shard_id_fkey FOREIGN KEY (shard_id) REFERENCES public.shards(id) ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
...
ALTER TABLE ONLY public.shard_metrics
    ADD CONSTRAINT shard_metrics_shard_id_fkey FOREIGN KEY (shard_id) REFERENCES public.shards(id) ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;


--
-- Name: sync_log sync_log_repo_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
