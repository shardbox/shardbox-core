...
describe Repo::Ref do
  ...
  it "#base_url_source" do
    Repo::Ref.new("github", "foo/bar").base_url_source.should eq URI.parse("https://github.com/foo/bar/blob/master/")
    Repo::Ref.new("github", "foo/bar").base_url_source("12345").should eq URI.parse("https://github.com/foo/bar/blob/12345/")
    Repo::Ref.new("gitlab", "foo/bar").base_url_source.should eq URI.parse("https://gitlab.com/foo/bar/blob/master/")
    Repo::Ref.new("gitlab", "foo/bar").base_url_source("12345").should eq URI.parse("https://gitlab.com/foo/bar/blob/12345/")
